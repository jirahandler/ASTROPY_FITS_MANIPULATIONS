# !/usr/bin/env python3
#Program to sort and stack FITS files by several criteria
import shutil
import csv
import pandas as pd
import fnmatch
            ...
            for i in range(1, 13):
                ...
                for j in range(1, num_lines-2):
                    if  resl <= f2r.iloc[j][4] <= resu:
                        ...
                        mrc.write('\n')
                mrc.close()
                os.chdir('/home/soumyananda/Dropbox/Goswami/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/')
                ...
                for k in range(1, n):
                    ...
                    s1 = str(btemp) + "_" + str(ctemp) + "_GALEX_FUV.fits"
                    #print(s1)
                    f1.write(s1)
                    f1.write("\n")
                    os.chdir('/home/soumyananda/Dropbox/Goswami/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/')
                    for file in os.listdir('.'):
                        if fnmatch.fnmatch(file, s1):
                            temp = "/home/soumyananda/Dropbox/Goswami/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/" + z + "/"
                            shutil.copy2(file, temp)
                image_concat = []
                temp1 = "/home/soumyananda/Dropbox/Goswami/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/" + z + "/"
                os.chdir(temp1)
                ...
                s = "stack_galfuv6as_" + str(i) + ".fits"
                s1 = "stack_galfuv6as_" + str(i) + ".png"
                os.makedirs(
                    '/home/soumyananda/Dropbox/Goswami/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES/',
                    exist_ok=True)
                os.chdir("/home/soumyananda/Dropbox/Goswami/DATA_FITS_KIDS_GAMA_VST/GALEX_FUV_FITS_6AS/STACKED_IMAGES/")
